    ...
    <section id="contactus" className="mx-auto w-5/6 pt-24 pb-32">
        <motion.div onViewportEnter={()=>setSelectedPage(SelectedPage.ContactUs)}>
            ...
            <motion.div className="md:w-3/5" initial="hidden" whileInView="visible" viewport={{once:true,amount:0.5}} transition={{duration:0.5}} variants={{
                ...
                <p className="my-5">Lorem ipsum dolor sit amet, consectetur adipisicing elit. Nobis, incidunt omnis suscipit libero minima dolorum beatae fuga ipsa assumenda nam, et, vitae voluptates explicabo modi quidem illo accusamus atque! Mollitia.</p>
            </motion.div>
            {/* FORM AND IMAGE */}
            <div className="mt-10 justify-between gap-8 md:flex">
                <motion.div className="mt-10 basis-3/5 md:mt-0" initial="hidden" whileInView="visible" viewport={{once:true,amount:0.5}} transition={{duration:0.5}} variants={{
                    ...
                    <form target="_blank" onSubmit={onSubmit} method="POST" action="https://formsubmit.co/bfea63c0c2225ca5ac39e2e13e2bbc85">
                ...
                <motion.div className="relative mt-16 basis-2/5 md:mt-0" initial="hidden" whileInView="visible" viewport={{once:true,amount:0.5}} transition={{delay:0.2,duration:0.5}} variants={{
                    ...
                    <div className="md:before:content-evolvetext w-full before:absolute before:bottom-20 before:right-10 before:z-[-1]">
                        <img className="w-full" alt="" src={ContactUsPageGraphic}/>
                    </div>
                </motion.div>
            </div>
        </motion.div>
