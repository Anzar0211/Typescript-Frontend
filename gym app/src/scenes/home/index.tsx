...
const Home = ({setSelectedPage}: Props) => {
    ...
    return (
        ...
        <motion.div className="md:flex mx-auto w-5/6 items-center justify-center h-5/6" onViewportEnter={()=>setSelectedPage(SelectedPage.Home)}>
            {/* MAIN HEADER */}
            <div className="mt-32 z-10 md:basis-3/5">
                ...
                <motion.div className="md:-mt-20" initial="hidden" whileInView="visible" viewport={{once:true,amount:0.5}} transition={{duration:0.5}} variants={{
                    ...
                    <p className="mt-8 text-sm">Lorem ipsum dolor sit amet consectetur adipisicing elit. Veniam a inventore numquam distinctio nisi tempore quod cum iusto accusantium. Itaque voluptatem sunt distinctio atque et nulla delectus totam aliquam? Doloremque.
                    </p>
                </motion.div>
                {/* ACTION BUTTONS */}
            ...
            <div className="flex basis-3/5 justify-center md:z-10 md:ml-40 md:mt-16 md:justify-items-center">
                ...
                {/* <img src={SponsorRedBull} alt="home-page-graphic" /> */}
            </div>
        </motion.div>
        {/* SPONSORS */}
